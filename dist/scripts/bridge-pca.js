...
// import { colorParsley, colorToHex, colorToRGB } from "./colorparsley.js";
...
function bridgeContrast(text, background) {
  let textColor = colorParsley(text);
  let backgroundColor = colorParsley(background);

  let txtY = sRGBtoY(textColor);
  let bgY = sRGBtoY(backgroundColor);
